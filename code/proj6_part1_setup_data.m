...
%             cur_images = datasample(cur_images, num_train_per_category);
        elseif(set == 2)
...
disp(image_counter)
netimage = netimage ./ image_counter;


for i = 1: image_counter - 1
    imdb.images.data(:,:,1,i) = imdb.images.data(:,:,1,i) - netimage;
end
