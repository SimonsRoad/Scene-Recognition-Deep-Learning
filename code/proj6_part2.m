...
% performance.
opts.learningRate = [0.001 0.001 0.001 0.0001 0.00005] ;
...
%% --------------------------------------------------------------------
fprintf('Lowest validation top1erorr is %f\n', min(cat(1, info.val(:).top1err)))
fprintf('Lowest validation top5erorr is %f\n', min(cat(1, info.val(:).top5err)))
end
